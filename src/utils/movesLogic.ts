...
export const getMoves = (position: position, boardMatrix: boardMatrix, name: string, castles: castles) => {
    ...
    if (name.includes("Ki")) {
        ...
        if (name[0] === "w") {
            if (castles.white000 && getPos(0, 7) === "wR" && getPos(2, 7) === "e") calcMoves(-2, 0, false, "white000");
            if (castles.white00 && getPos(7, 7) === "wR" && getPos(6, 7) === "e") calcMoves(2, 0, false, "white00");
        }
        if (name[0] === "b") {
            if (castles.black000 && getPos(0, 0) === "bR" && getPos(2, 0) === "e") calcMoves(-2, 0, false, "black000");
            if (castles.black00 && getPos(7, 0) === "bR" && getPos(6, 0) === "e") calcMoves(2, 0, false, "black00");
        }
    }
